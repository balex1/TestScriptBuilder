...
class WFCarouselItem(BoxLayout):
    ...
    ip1_name = StringProperty('')
    ip2_name = StringProperty('')
    ip3_name = StringProperty('')
    ...
    def __init__(self, **kwargs):
        ...
        self.bind(ip1_name=self.SetIP1Hint)
        self.bind(ip2_name=self.SetIP2Hint)
        self.bind(ip3_name=self.SetIP3Hint)
    ...
    def SetIP1Hint(self, *args):
        self.ip_in.hint_text = self.ip1_name
    def SetIP2Hint(self, *args):
        self.ip2_in.hint_text = self.ip2_name
    def SetIP3Hint(self, *args):
        self.ip3_in.hint_text = self.ip3_name