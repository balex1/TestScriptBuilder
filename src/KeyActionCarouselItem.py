...
class KeyActionCarouselItem(BoxLayout):
	...
	def __init__(self, **kwargs):
		...
		ipgrid = GridLayout(rows=3, size_hint=(1, 0.33))
		...
		self.sa_in = satext
		katext = TextInput(hint_text='Key Action', size_hint=(1, 0.235))
		self.ka_in = katext
		desctext = TextInput(hint_text='Description', size_hint=(1, 0.235))
